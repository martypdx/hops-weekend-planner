...
router
    .get('/:id', (req, res, next) => {
        let ToveLoId = req.params.id;
        let tracksArr = [];
        let usersHead = {
            Authorization: 'Bearer BQB8qik1RwwAjdCoCwWL63RBm_kUa3ZgmDNBockGTpW8zeUqtszksOf9haAqz7gDn38hay8QhpXByk60xZacDmoDu8khJDTFtks3jJt5G2w9CCBaHk7uRoBwgLdUmUus7PClMF5581tLsBhDpM-d1kO0-ILxsN8Aqu4R4RPvQwlWDqV1Z4qcjhh_fKRvVIuTq0Hw1Qz-meOEMf2mQlK-Nb5cNityCI4MC4uxYkBGXk5khWcBkEDTFNuXvmUHPXpHtgnj102t'
        };
        request.headers = usersHead;
